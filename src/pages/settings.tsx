        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl border p-6 flex justify-between items-center shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">Public Brand Identity</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    {tests.length} active tests available for booking.
                  </p>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-600 rounded-2xl p-6 shadow-lg border border-indigo-500 text-white">
              ...
              <button onClick={() => alert("Coming soon")} className="w-full bg-white text-indigo-600 py-2.5 rounded-xl text-xs font-bold flex items-center justify-center gap-2 shadow-inner"><Plus className="w-4 h-4" /> New Booking</button>
            </div>
