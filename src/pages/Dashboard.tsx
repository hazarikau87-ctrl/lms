...
// 3. IMPORT THE DENSITY CONTROL RESPONSIVE GRID COMPONENT
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-500 selection:text-white antialiased">
        ...
        {currentView === 'settings' ? (
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm overflow-hidden">
              ...
              {/* CLEAN SEPARATED TABLE COMPONENT INSERTION POINT */}
              <BookingTable 
                loading={loading}
                paginated={paginated}
      ...
      {/* MOUNT THE RESCHEDULEDRAWER WITH CLEAN REBIND CALLBACK STATE INTERSECTION */}
      <RescheduleDrawer 
      ...
      {/* FLOATING DYNAMIC SYSTEM ACTION BAR WITH EXCEL INTEGRATION */}
      <ActionBar 
        selectedIds={selectedIds}
